...
const sortedBy: {q:string,text:string}[] = [
    ...
    { text: 'Popularity Ascending', q: 'popularity.asc' },
    { text: 'Release Date Descending', q: 'release_date.desc' },
    { text: 'Release Date Ascending', q: 'release_date.asc' },
    { text: 'Revenue Descending', q: 'revenue.desc' },
